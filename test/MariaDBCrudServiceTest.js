...
describe('CrudService', () => {
                    ...
                    app.services.db.query(`
                        CREATE TABLE \`crud_test\`.\`user\` (
                          ...
                          UNIQUE KEY \`username_UNIQUE\` (\`username\`)
                            ...
                            // should instantiate
                            crud = new MariaDBCrudService(app, {
    ...
    describe('constructor', () => {
        ...
        it('should accept various options', (done) => {
            ...
            app.config.mariadb.my_database.database = 'crud_test';
            let crud = new MariaDBCrudService(app, {
                service: app.services.db,
                table: 'user',
                createRetryCount: 2,
                modifiableKeys: ['hi'],
            ...
            delete app.config.mariadb.my_database.database;
        ...
        it('should throw when missing options ', () => {
            ...
            (() => new MariaDBCrudService(app)).should.throw(/options/);

            (() => new MariaDBCrudService(app, {})).should.throw(/service/);
            (() => new MariaDBCrudService(app, {service: app.services.db})).should.throw(/database/);
            (() => new MariaDBCrudService(app, {service: app.services.db, schema: 'crud_test'})).should.throw(/table/);
    ...
    describe('init', () => {
        ...
        describe('basic usage', () => {
            ...
            before(async () => {
                ...
                class UnitTestService extends MariaDBCrudService {
    ...
    describe('_createWithRetry', () => {
        ...
        it('should give up when the closure is stubborn', (done) => {
            crud.createWithRetry({
                id: 'c',
                username: 'c',
                email: 'c@c.com',
        ...
        it('should give up when the closure is stubborn w/ promise', (done) => {
            crud.createWithRetry({
                id: 'a',
                username: 'a',
                email: 'a@a.com',
        ...
        it('should error if you botch a data type', (done) => {
            crud.retrieve('a', null, (err, doc) => {
                ...
                crud.update(doc, {}, null, (err, doc2) => {
                    ...
                    should(err.errno).be.exactly(1292);
    ...
    describe('_deletePermanently', () => {
        ...
        it('should handle errors', (done) => {
            const doc = { id: { toSqlString: () => { throw new Error('kaboom'); } } };
            crud.deletePermanently(doc, (err, doc2) => {
                should(err).be.ok();
                should(doc2).not.be.ok();

                // should(err.errno).be.exactly(5003);
    ...
    describe('_bulkDeletePermanently', () => {
        ...
        it('should handle errors', (done) => {
            crud.bulkDeletePermanently({ bogus: true }, null, (err, res) => {
                should(err).be.ok();
                should(res).not.be.ok();
    ...
    describe('Transactions', () => {
        ...
        it('_retrieve in transaction', (done) => {
            crud.retrieve('txn', { session: connection }, (err, doc) => {
                should(err).not.be.ok();
                should(doc).be.ok();
        ...
        it('_find in transaction', (done) => {
            crud.find({ id: 'txn2' }, { session: connection }, (err, docs) => {
                should(err).not.be.ok();
                should(docs).be.ok();
        ...
        it('_update in transaction', (done) => {
            crud.update({ id: 'txn', first_name: 'changed' }, {}, { session: connection }, (err, doc) => {
                should(err).not.be.ok();
                should(doc).be.ok();
        ...
        it('_bulkUpdate in transaction', (done) => {
            crud.bulkUpdate({ id: 'txn' }, { last_name: 'bulk' }, { session: connection }, (err, res) => {
                should(err).not.be.ok();
                should(res).be.ok();
        ...
        it('_delete in transaction', (done) => {
            crud.delete({ id: 'txn2' }, { session: connection }, (err, doc) => {
                should(err).not.be.ok();
                should(doc).be.ok();
        ...
        it('_bulkDelete in transaction', (done) => {
            crud.bulkDelete({ id: 'txn2' }, { session: connection }, (err, res) => {
                should(err).not.be.ok();
        ...
        it('_deletePermanently in transaction', (done) => {
            crud.deletePermanently({ id: 'txn2' }, { session: connection }, (err, doc) => {
                should(err).not.be.ok();
                should(doc).be.ok();
        ...
        it('_bulkDeletePermanently in transaction', (done) => {
            crud.bulkDeletePermanently({ id: 'txn' }, { session: connection }, (err, res) => {
                should(err).not.be.ok();
